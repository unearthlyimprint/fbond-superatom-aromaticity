...
\begin{table}[H]
  ...
  natural orbitals: $S_E(n_i) = -n_i \ln n_i - (2-n_i)\ln(2-n_i)$.
  This differs from the frontier-only $S_E^C = S_E(n_{\text{HOMO}})$
  reported in the main text Table~4 and SI Table~2, which is evaluated
  from only the HOMO occupation number. The full-space
