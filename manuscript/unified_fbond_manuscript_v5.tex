...
correlations between these metrics and $S_E^Q$ are uniformly
non-significant ($|\rho| < 0.28$, $p > 0.4$ for all metrics; see
Supporting Information for full data). Notably, even the number of
qubits shows no correlation with $S_E^Q$ ($\rho = 0.04$, $p = 0.93$).
